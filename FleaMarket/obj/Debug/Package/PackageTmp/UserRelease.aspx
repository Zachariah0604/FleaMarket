<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRelease.aspx.cs" Inherits="FleaMarket.UserRelease" %>
<%@ Register TagPrefix="FleaMarketHead" TagName="head" Src="~/head.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>用户发布--山东理工大学跳蚤市场</title>
...
<body>
    ...
    <FleaMarketHead:head ID="head" runat="server" />
            <div class="Rmiddle">
                ...
                <div class="REright">
                    <div class="Releasetitle"><font>用户发布:</font></div>
                    <div class="Release">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td>*联系人姓名:</td>
                            <td width="480px"><asp:TextBox ID="TxtName" runat="server"  class="Input"></asp:TextBox></td>
                        ...
                        <tr>
                            <td>*学号:</td>
                            <td width="480px"><asp:TextBox ID="TxtStudentID" runat="server" class="Input"></asp:TextBox>让你的商品更值得信任</td>
                        ...
                        <tr>
                            <td>*联系电话:</td>
                            <td width="480px"><asp:TextBox ID="TxtPhone"  runat="server" class="Input"></asp:TextBox></td>
                        ...
                        <tr>
                            <td>电子邮箱:</td>
                            <td width="480px"><asp:TextBox ID="TxtEmail" runat="server" class="Input"></asp:TextBox></td>
                        ...
                        <tr>
                            <td>QQ号:</td>
                            <td width="480px"><asp:TextBox ID="TxtQQ" runat="server" class="Input"></asp:TextBox></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>转让价格:</td>
