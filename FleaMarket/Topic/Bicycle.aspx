<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bicycle.aspx.cs" Inherits="FleaMarket.Topic.Bicycle" %>
<%@ Register TagPrefix="FleaMarketTopicHead" TagName="TopicHead" Src="TopicHead.ascx" %>
...
<body>
    ...
    <FleaMarketTopicHead:TopicHead ID="TopicHead" runat="server" />
        <div id="SearchMain">
		    <div id="SearchLeft">
