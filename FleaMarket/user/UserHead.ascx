<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserHead.ascx.cs" Inherits="FleaMarket.user.UserHead" %>
            ...
            <div id="user">
                <asp:Panel ID="text" runat="server">
                    <div style=" float:right;">
                        <table><tr><td>您尚未</td><td><div id="content"><a href="#">&nbsp;登录&nbsp;</a></div></td><td>或</td><td><a href="UserReg.aspx" target="_top">&nbsp;注册</a></td></tr></table>
                    </div>
                </asp:Panel>
        ...
        <div class="login">
             <div id="loginForm">
		                <H3>山东理工大学校园二手跳蚤市场用户登录</H3>
							...
							<DIV class="youke">
			                            不想登录？那就以游客身份<a href="TouristRelease.aspx" target="_blank" style=" color:red;">立即发布</a>二手信息。
		                    </DIV>
	                </div>
        </div>
   </div>
