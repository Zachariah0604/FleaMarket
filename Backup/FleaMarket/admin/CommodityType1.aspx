<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommodityType1.aspx.cs" Inherits="FleaMarket.admin.CommodityType1" %>
...
<body>
    ...
    <div>
        添加一级分类：<asp:TextBox ID="Type1" runat="server"></asp:TextBox>
        <asp:Button ID="TypeButton" runat="server" Text="添加" onclick="TypeButton_Click" /><br /><br />
