...
{
    public partial class UserHead : System.Web.UI.UserControl
    {
        ...
        {
            Response.Redirect("UserCollect.aspx");
        }
        ...
        protected void userLoginButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Page.ClientScript.RegisterStartupScript(Page.GetType(), "RefreshParent", "<script language='javascript'>alert('请填写完整信息再点击登录')</script>");
